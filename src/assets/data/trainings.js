...
import grossesse from "../images/formations/header_smn_gynaecology.png"
import Kiné from "../images/formations/cervicalgie-institut-kinesitherapie-paris.jpg.webp"
...
export const trainings = [
{
  id: 1,
        ...
        "Intégrer l’analyse de l’occlusion statique et dynamique dans la démarche diagnostique afin d’optimiser les plans de traitement prothétique.",
"Instaurer systématiquement un bilan occlusal préalable avant toute intervention prothétique pour sécuriser les étapes cliniques à venir." ,
"Ancrer la sélection rigoureuse de la position de référence comme étape clé dans la planification prothétique, en fonction des situations cliniques.",
"Mettre en place une communication structurée et ciblée avec le prothésiste pour limiter les ajustements post-fabrication.",
"Adapter les dispositifs prothétiques à l’occlusion spécifique de chaque patient pour assurer leur stabilité, leur confort et leur durabilité.",
        ]
        ,
...
Les kinésithérapeutes sont impliqués en premier lieu dans la prise en charge de cette pathologie par sa fréquence en cabinet, et sont donc les interlocuteurs et intervenants de choix auprès des patients atteints. 

Cette formation DPC sous forme d’audit clinique permet au kinésithérapeute d’évaluer et d'améliorer ses pratiques sur la prise en charge globale des cervicalgies aiguës : du bilan d'évaluation au traitement de rééducation à mettre en place. 
        ...
        "Améliorer la qualité de l’évaluation des cervicalgies aiguës en utilisant des outils cliniques validés. ",
"Renforcer la capacité à détecter et réorienter les cas à risques en identifiant les 'drapeaux rouges' de la cervicalgie et en orientant vers les soins spécialisés lorsque nécessaire.",
"Optimiser l’identification des facteurs de risque environnementaux et comportementaux liés à la cervicalgie aiguë (ergonomie, habitudes de vie, posture) pour une prise en charge préventive et personnalisée.",
"Renforcer l’utilisation des tests cliniques et fonctionnels adaptés à la cervicalgie aiguë afin d'affiner le diagnostic et de mieux personnaliser le plan de traitement.",
"Élaborer des plans de prise en charge personnalisés pour la cervicalgie aiguë en fonction des dernières recommandations, incluant des stratégies de gestion de la douleur et de la mobilité.",
,
        ]
        ,
...
Face à l’évolution souvent silencieuse de ces lésions, il est essentiel de développer une vigilance accrue et d’intervenir précocement pour limiter les traitements invasifs futurs.
Organisée sous forme d’audit clinique, cette formation vise à évaluer et améliorer les pratiques professionnelles à travers l’analyse de cas concrets et la confrontation aux référentiels actuels.

Elle permet aux chirurgiens-dentistes d’optimiser leur démarche diagnostique et thérapeutique, en s’appuyant sur les dernières avancées scientifiques et les principes de la pratique fondée sur les preuves.`,
        objectifs:[
        
"Intégrer de manière systématique l’évaluation des facteurs de risque d’usure dentaire dans le questionnaire médical et l’anamnèse.",
"Standardiser l’évaluation et la prise en charge des usures en utilisant le score BEWE dans la pratique courante.",
"Optimiser les plans de traitement en fonction du type d’usure, de sa sévérité et de son retentissement fonctionnel/esthétique.",
"Mettre en place une stratégie de prévention personnalisée.",
        ]
        ,
        Public:`Chirurgiens-Dentistes`,
        modalite:["Evaluation des pratiques professionnelles – Audit clinique."],
...
C’est donc un enjeu majeur de santé publique et un enjeu économique important du fait de son retentissement sur la vie professionnelle des malades.

Cette formation DPC sous forme d’audit clinique permet au kinésithérapeute d’évaluer et d'améliorer ses pratiques sur la prise en charge globale des lombalgies chroniques : du bilan d'évaluation au traitement de rééducation à mettre en place.`,
        modalite:["Evaluation des pratiques professionnelles – Audit clinique "],
        objectifs:[
        
"Améliorer l’évaluation des lombalgies chroniques en utilisant des outils standardisés.", 
"Renforcer la capacité à détecter les 'drapeaux rouges' de la lombalgie, et orienter efficacement les patients vers les soins appropriés.",
"Optimiser l’identification des facteurs de risque environnementaux et comportementaux (ergonomie, habitudes de vie) pour une prise en charge préventive.",
"Renforcer l’utilisation de tests cliniques adaptés pour affiner le diagnostic et personnaliser le traitement de la lombalgie chronique.",
"Élaborer des plans de prise en charge personnalisés basés sur des recommandations récentes pour améliorer les résultats fonctionnels."
...
Organisée sous forme d'audit clinique, cette formation permet d’évaluer et de perfectionner les pratiques professionnelles en matière de restaurations adhésives. À travers l’analyse de situations réelles, elle aide les praticiens à confronter leurs actes aux référentiels actuels, renforçant ainsi leur expertise esthétique, fonctionnelle et biologique pour mieux répondre aux attentes contemporaines des patients.`,
        objectifs:[
        
"Améliorer la précision du diagnostic des lésions dentaires carieuses et des atteintes pulpaires en intégrant des critères cliniques et radiographiques standardisés dans la pratique quotidienne.",
"Optimiser l’évaluation de la résistance des structures dentaires résiduelles. ",
"Renforcer le suivi des les protocoles recommandés et la mise en œuvre des matériaux de collage.",
"Optimiser la pérennité des traitements et le suivi des complications post opératoires."
,
        ]
        ,
        Public:`Chirurgiens-Dentistes`,
...
Bien qu’elles ne puissent pas prendre en charge les patientes dans leur globalité en cas de pathologie avérée, les sages-femmes, de par leurs connaissances, leur place auprès des femmes et leur réseau, sont des professionnels de référence dans la coordination de la prise en charge de l’endométriose pour les patientes. 

Cette formation DPC, sous forme d’évaluation des pratiques professionnelles, permet aux sage-femmes d’évaluer leurs connaissances sur l’endométriose, ses symptômes, son diagnostic et son suivi afin d’améliorer le dépistage et l’accompagnement global des patientes.
  `,
        modalite:["Evaluation des pratiques professionnelles – Audit clinique "],
        objectifs:[
...
,
        ...
        duration:`4 heures (2 x 2 heures) - prévoir 3 mois entre les deux audits cliniques.`,
...
Cette formation DPC, qui se présente sous forme d’évaluation des pratiques professionnelles, permet aux sages-femmes de tester et renforcer leurs connaissances sur la grossesse et son suivi. L’objectif est d’améliorer l’accompagnement des patientes sur les plans clinique, paraclinique et psycho-social, d’assurer un suivi personnalisé et ciblé, et d'optimiser le dépistage des pathologies obstétricales.
`,

    modalite:["Evaluation des pratiques professionnelles – Audit clinique"],
        objectifs:[
        
"Optimiser le suivi des recommandations en matière de dépistages cliniques, biologiques et échographiques.",
"Améliorer la détection précoce des risques obstétricaux par la sage-femme.",
"Améliorer le repérage des vulnérabilités sociales, psychologiques et médicales durant la grossesse.",
"Favoriser le développement de la préparation à la naissance et à la parentalité tout au long de la grossesse.",
        ]
        ,
        Public:`Sages-femmes`,
        tarif: "343,50",
...
Cette formation DPC permet d’actualiser les connaissances et la réflexion sur la pratique des sage-femmes impliquées dans le projet de naissance d’un enfant et l’accompagnement du post partum.`,
    ...
    modalite:["Formation continue - Classe virtuelle "],
        ...
        "Actualiser les connaissances et la réflexion sur la pratique des sages-femmes impliquées dans le projet de naissance d’un enfant.",
        "Apprendre à prévenir les risques pendant la grossesse (alimentation, vaccination).",
        "Savoir réaliser l’entretien prénatal précoce .",
        "Savoir repérer et prendre en charge les vulnérabilités sociales et psychiques et les situations de fragilité parentale.",
        "Proposer aux futurs parents des séances de préparation à la naissance.",
        "Savoir organiser et optimiser le retour à domicile après la naissance.",
        "Savoir mettre en place une contraception adaptée",
        ]
        ,
        Public:`Sages-femmes`,
        tarif: "336,60",
        ...
        duration:`6 heures (1 journée)`,
        numeroActionDPC:`9AVK2525002`,
        moyensPedagogiques:
        [
        "Classes virtuelles synchrones animées par un formateur.",
        "Support pédagogique projeté.",
        "Échanges interactifs et mises en situation."

        ],
        dispositifEvaluation:
        [
        "Chaque module se termine par une phase d’évaluation comprenant un tour de table, des échanges avec le formateur, un quiz de fin de module ainsi qu’un feedback individualisé. La formation se clôture par une évaluation finale sous forme de questionnaire à choix multiple (QCM)."
        ],
        programme: [
        {introduction:"La formation débute par une introduction au programme, la présentation du formateur, ainsi qu’une évaluation de positionnement permettant de mesurer les connaissances fondamentales des participants.",
          module:[
            "Module 1 : 45 minutes",
            "Module 2 : 45 minutes",
            "Module 3 : 45 minutes",
          ...
          Presentation_module:[
            "Conseils pré-nataux et risques environnementaux ",
            "Dépistage et prise en charge précoce des vulnérabilités",
            "Modalités d’accouchement et préparation à la naissance",
            "Post partum immédiat et première semaine de vie",
          ...
          objectif:[
            "Apprendre à prévenir les risques pendant la grossesse",
            ["Savoir réaliser l’entretien prénatal précoce." ,"Savoir repérer et prendre en charge les vulnérabilités sociales et psychiques et les situations de fragilité parentale."],
            "Proposer aux futurs parents des séances de préparation à la naissance",
            " Savoir organiser et optimiser le retour à domicile après la naissance",
            ["Optimiser l’accompagnement à la parentalité en période post-natale" , "Savoir mettre en place une contraction adaptée"],
            "Tester ses connaissances sur un cas clinique traitant de l’accompagnement à la parentalité",
            "Tester ses connaissances sur un cas clinique traitant de l’accompagnement à la parentalité",
            " Tester ses connaissances sur un cas clinique traitant de l’accompagnement à la parentalité",
...
Financements:`DPC, FIFPL, AGEFICE, OPCO, France Travail`,
        ...
        `100% pris en charge sans avance de frais*
         Validant votre obligation de triennale DPC
         264€ d’indemnisation en exercice libéral`,
    ...
    Session:[
        ...
        {
            id:1 ,
            DateSession:"03/07/2025",
            NumSession:"25.001"
        },

        {
            id:2 ,
            DateSession:"15/07/2025",
            NumSession:"25.002"
        },

        {
            id:3 ,
            DateSession:"24/07/2025",
            NumSession:"25.003"
        }
      ],
...
Il convient également pour le kinésithérapeute d’être particulièrement vigilant quant à la conduite à tenir, et notamment d’évaluer s’il est de son ressort de prendre en charge ce patient ou de le réorienter pour un diagnostic complémentaire si nécessaire.

Cette formation permet au kinésithérapeute de consolider ses connaissances sur la prise en charge de la cervicalgie aigüe, tant dans le bilan d’évaluation que sur le traitement et  rééducation à mettre en place.

Cette formation DPC  sur la prise en charge de la cervicalgie aigüe en cabinet de kinésithérapie permet : 
Une mise à jour des connaissances des kinésithérapeutes sur l’anatomie de la région cervicale.
De fournir aux kinésithérapeutes des outils de bilan leur permettant d’établir un protocole de rééducation adéquat.
...
`,
    ...
    modalite:["Formation continue - Classe virtuelle"],
        ...
        "Consolider les connaissances anatomiques des kinésithérapeutes sur la région cranio-cervico-scapulaire.",
        "Améliorer les connaissances des kinésithérapeutes sur les douleurs et pathologies de la région cervicale.",
        "Maîtriser des outils de bilans adéquats pour évaluer la douleur et construire une rééducation.",
        "Savoir identifier les drapeaux rouges et réorienter le patient si nécessaire.",
        "Construire un programme de rééducation pour le patient cervicalgique en phase aiguë au cabinet.",
        "Informer le patient de façon éclairée sur sa douleur et le former pour une prise en charge autonome.",
        ]
        ,
        Public:`Masseur-Kinésithérapeute`,
        tarif: "319,20",
        ...
        dispositifEvaluation:
        [
        `Chaque module se termine par une phase d’évaluation comprenant un tour de table, des échanges avec le formateur, un quiz de fin de module ainsi qu’un feedback individualisé.
         La formation se clôture par une évaluation finale sous forme de questionnaire à choix multiple (QCM).`
        ],
        programme: [
        {introduction:"La formation débute par une introduction au programme, la présentation du formateur, ainsi qu’une évaluation de positionnement permettant de mesurer les connaissances fondamentales des participants.",
          module:[
          ...
          Presentation_module:[
            "Rappels anatomiques",
            "Cas cliniques ",
            "Etiologies de la cervicalgie aigüe",
            "Cas cliniques",
            "Outils de bilan kinésithérapique et dossier patient ",
            "Tests de mobilité articulaire et de tonus musculaire – Drapeaux rouges",
            "Cas clinique 2",
            "Outils de rééducation au cabinet libéral",
            "Autonomie du patient et prévention",
            "Cas cliniques ",
          
          ],
          objectif:[
            " Consolider les connaissances anatomiques des kinésithérapeutes sur la région cervicale et scapulaire",
            "Tester ses connaissances sur des cas cliniques sur l’anatomie de la région cervicale et scapulaire.",
            "Améliorer les connaissances des kinésithérapeutes sur les pathologies de la région cervicale et les facteurs de risque de la cervicalgie aigüe.",
            "Tester ses connaissances sur des cas cliniques sur les pathologies et les facteurs de risques de la cervicalgie aigüe.",
            "Rassembler les informations essentielles du patient pour comprendre sa pathologie.",
            ["Maîtriser des outils de bilans adéquats pour construire une rééducation." , "Savoir identifier les drapeaux rouges et réorienter le patient si nécessaire."],
            "Tester ses connaissances sur des cas cliniques sur les tests de la région cervicale.",
            "Construire un programme de rééducation au cabinet pour le patient cervicalgique aigüe.",
            " Rendre le patient autonome dans la prise en charge de sa pathologie.",
            "Tester ses connaissances sur des cas cliniques sur la rééducation du patient cervicalgique en phase aigüe en cabinet libéral.",
...
Financements:`DPC, FIFPL, AGEFICE, OPCO, France Travail`,
  ...
  skills: [
    "Connaissances approfondies de l’anatomie cervicale : Consolidation des savoirs anatomiques relatifs à la région cranio-cervico-scapulaire, essentiels à l’évaluation et au traitement des douleurs cervicales.",
    "Évaluation clinique précise de la cervicalgie aiguë : Maîtrise des outils de bilan permettant d’identifier les causes possibles, d’évaluer la douleur et de déterminer un plan de rééducation personnalisé.",
    "Identification des drapeaux rouges : Capacité à repérer les signes d’alerte nécessitant une réorientation médicale, garantissant une prise en charge sécurisée et adaptée au patient.",
    "Élaboration d’un protocole de rééducation efficace : Compétence dans la construction d’un programme de soins structuré pour les patients en phase aiguë, en tenant compte des limitations fonctionnelles et de l’évolution des symptômes.",
  ...
  Session:[
        ...
        {
            id:1 ,
            DateSession:"26/06/2025",
            NumSession:"25.001",
        },

        {
            id:2 ,
            DateSession:"05/08/2025",
            NumSession:"25.002",
        },

        {
            id:3 ,
            DateSession:"12/08/2025",
            NumSession:"25.003",
        }
      ],
...
À l’issue de la formation, vous serez en mesure d’optimiser la prise en charge en cabinet et de fluidifier le parcours de soins de vos patientes
`,

    modalite:["Formation continue - Classe virtuelle"],
        objectifs:[
        
        "Identifier les signes cliniques de l’endométriose pour améliorer le dépistage en cabinet.",
        " Prescrire et expliquer les examens paracliniques de première intention en cas de suspicion d’endométriose.",
        "Savoir orienter les patientes vers les spécialistes médicaux adaptés.",
        "Proposer un traitement de première intention hormonal et antalgique.",
        "Accompagner les patientes dans la gestion de la douleur pour améliorer leur qualité de vie.",
        "Favoriser une prise en charge collaborative et coordonnée en réseau pour assurer un suivi global des patientes atteintes d'endométriose. ",
        ]
        ,
        Public:`Sages-femmes`,
        tarif: "336,60",
        ...
        {introduction:"La formation débute par une introduction au programme, la présentation du formateur, ainsi qu’une évaluation de positionnement permettant de mesurer les connaissances fondamentales des participants.",
          ...
          objectif:[
            ["Savoir réaliser un examen clinique gynécologique adapté en cas de suspicion d’endométriose", 
             "Prescrire et expliquer les examens paracliniques de première intention en cas de suspicion d’endométriose",
             "Savoir orienter les patientes vers les spécialistes médicaux adaptés",
            ],
            [
              "Connaître et expliquer les différentes options thérapeutiques de l’endométriose.",
              "Proposer un traitement de première intention hormonal et antalgique.",
              "Savoir orienter les patientes vers les spécialistes médicaux adaptés .",
              "Accompagner les patientes dans la gestion de la douleur pour améliorer leur qualité de vie."
            ...
            [
            "Identifier les ressources locales et nationales disponibles (associations de patients, support psychologique, etc.) et orienter les patientes vers ces supports pour un accompagnement global.",
            "Favoriser une prise en charge collaborative et coordonnée en réseau pour assurer un suivi global des patientes atteintes d'endométriose. "
            ],
            "Tester ses connaissances sur un cas clinique traitant de la prise en charge de l’endométriose.",
            "Tester ses connaissances sur un cas clinique traitant de la prise en charge de l’endométriose.",
            "Tester ses connaissances sur un cas clinique traitant de la prise en charge de l’endométriose",
            "Tester ses connaissances sur un cas clinique traitant de la prise en charge de l’endométriose",
            "Tester ses connaissances sur un cas clinique traitant de la prise en charge de l’endométriose",
...
Financements:`DPC, FIFPL, AGEFICE, OPCO, France Travail`,
  ...
  skills: [
    "Identification des signes cliniques évocateurs de l’endométriose : Capacité à repérer précocement les symptômes caractéristiques de l’endométriose lors des consultations en cabinet, afin d'améliorer le dépistage et d’orienter rapidement la prise en charge.",
    "Prescription et interprétation des examens paracliniques de première intention : Compétence dans la prescription d’examens adaptés (échographie pelvienne, IRM, etc.) et la communication claire des résultats et de leur signification aux patientes.",
    "Orientation spécialisée et coordination du parcours de soins : Aptitude à orienter efficacement les patientes vers les spécialistes adéquats (gynécologues, centres experts de l’endométriose) et à intégrer la sage-femme dans une prise en charge pluridisciplinaire.",
    "Mise en place d’un traitement de première intention : Capacité à proposer et expliquer un traitement hormonal ou antalgique initial adapté aux symptômes de la patiente, en concertation avec les recommandations actuelles.",
    "Accompagnement dans la gestion de la douleur chronique : Compétence à soutenir les patientes dans la gestion de la douleur liée à l’endométriose, en proposant des stratégies adaptées pour améliorer leur qualité de vie au quotidien.",
    "Approche collaborative et suivi global de l’endométriose : Capacité à travailler en réseau avec les autres professionnels de santé pour assurer une prise en charge coordonnée et continue, centrée sur les besoins spécifiques de chaque patiente."
  ],
  ...
  Session:[
        ...
        {
            id:1 ,
            DateSession:"11/07/2025",
        },

        {
            id:2 ,
            DateSession:"22/07/2025",
        },

        {
            id:3 ,
            DateSession:"31/07/2025",
        }
      ],
...
Il existe encore en France un grand nombre d’idées reçues infondées dans la population concernant les douleurs du rachis lombaire et sur l’attitude à adopter pour y faire face. Le kinésithérapeute est l’intervenant de choix pour redonner au patient la conduite à tenir.

Cette formation permet au kinésithérapeute de consolider ses connaissances sur le sujet, tant dans le bilan à faire que sur la rééducation à mettre en place.
...
`,
    ...
    modalite:["Formation continue - Classe virtuelle"],
        ...
        "Consolider les connaissances anatomiques des kinésithérapeutes sur la région lombo-sacrée.",
        "Améliorer les connaissances des kinésithérapeutes sur les douleurs et pathologies de la région lombaire.",
        "Maîtriser des outils de bilans adéquats pour évaluer la douleur et construire une rééducation.",
        "Savoir identifier les drapeaux rouges et réorienter le patient si nécessaire.",
        "Construire un programme de rééducation pour le patient lombalgique chronique au cabinet.",
        "Informer le patient de façon éclairée sur sa douleur et le former pour une prise en charge autonome."
        ]
        ,
        Public:`Masseur-Kinésithérapeute`,
...
La formation se clôture par une évaluation finale sous forme de questionnaire à choix multiple (QCM).`
        ...
        {introduction:"La formation débute par une introduction au programme, la présentation du formateur, ainsi qu’une évaluation de positionnement permettant de mesurer les connaissances fondamentales des participants.",
          ...
          Presentation_module:[
            "Rappels anatomiques",
            "Cas cliniques ",
            "Etiologies de la lombalgie chronique",
            "Cas cliniques ",
            "Outils de bilan kinésithérapique et dossier patient",
            "Tests de mobilité articulaire et de tonus musculaire – Drapeaux rouges",
            "Cas clinique ",
          ...
          objectif:[
            "Consolider les connaissances anatomiques des kinésithérapeutes sur la région lombo-sacrée.",
           "Tester ses connaissances sur des cas cliniques sur l’anatomie de la région lombo-sacrée.",
            "Améliorer les connaissances des kinésithérapeutes sur les pathologies de la région lombaire et les facteurs de risque de la lombalgie chronique.",
            "Tester ses connaissances sur des cas cliniques sur les pathologies et les facteurs de risques de la lombalgie chronique.",
            "Rassembler les informations essentielles du patient pour comprendre sa pathologie.",
            ["Maîtriser des outils de bilans adéquats pour construire une rééducation.","Savoir identifier les drapeaux rouges et réorienter le patient si nécessaire."],
            "Tester ses connaissances sur des cas cliniques sur les tests de la région lombaire.",
            "Construire un programme de rééducation au cabinet pour le patient lombalgique chronique.",
            "Rendre le patient autonome dans la prise en charge de sa pathologie.",
            "Tester ses connaissances sur des cas cliniques sur la rééducation du patient lombalgique chronique en cabinet libéral."
...
Financements:`DPC, FIFPL, AGEFICE, OPCO, France Travail`,
  ...
  skills: [
    "Maîtrise de l’anatomie et des pathologies lombaires : Consolidation des connaissances anatomiques et biomécaniques de la région lombo-sacrée, indispensables à la compréhension des mécanismes de la lombalgie chronique.",
    "Évaluation clinique et fonctionnelle de la lombalgie : Capacité à utiliser des outils de bilan adaptés pour évaluer l’intensité, l’origine et l’impact de la douleur, en vue de construire un plan de rééducation individualisé.",
    "Identification des drapeaux rouges : Savoir repérer les signes cliniques évocateurs d’une pathologie grave ou nécessitant une prise en charge médicale spécialisée, et assurer une orientation sécurisée du patient.",
    "Élaboration d’un protocole de rééducation personnalisé : Compétence dans la mise en place d’un programme de soins structuré et progressif, adapté aux besoins et capacités du patient souffrant de lombalgie chronique.",
    "Techniques de rééducation en cabinet : Maîtrise des approches thérapeutiques permettant de restaurer la mobilité, de renforcer les capacités fonctionnelles et de réduire les douleurs persistantes du rachis lombaire.",
    "Éducation thérapeutique et autonomisation du patient : Capacité à déconstruire les idées reçues, à informer le patient de manière claire et rassurante, et à favoriser l’adoption de comportements actifs pour une meilleure prise en charge à long terme."
  ],
   ...
   Session:[
        ...
        {
            id:1 ,
            DateSession:"20/06/2025",
            NumSession:"25.001",
        },

        {
            id:2 ,
            DateSession:"29/07/2025",
            NumSession:"25.002",
        },

        {
            id:3 ,
            DateSession:"01/08/2025",
            NumSession:"25.003",
        }
      ],
...
Cette formation DPC, sous forme d’actualisation des connaissances permet aux sages-femmes de consolider et tester leurs connaissances sur la grossesse et son suivi afin d’améliorer l’accompagnement des patientes sur tous les plans (clinique, paraclinique, psycho-social), d’assurer un suivi ciblé adapté à chacune, et d’améliorer le dépistage des pathologies obstétricales.
`,

    modalite:["Formation continue - Classe virtuelle"],
        objectifs:[
        
        "Connaître le cadre général du suivi de grossesse. ",
        "Apprendre à prévenir les risques pendant la grossesse (alimentation, actualités vaccinales).",
        "Savoir dépister les facteurs de risques de vulnérabilités (psychologiques, addictions, violences).",
        "Connaître les examens de dépistage. ",
        "Savoir interpréter les bilans biologiques en cours de grossesse.",
        "Savoir dépister et adresser les principales complications de grossesse. ",
        "Pouvoir informer les femmes enceintes et les couples sur le déroulement et les suites de l’accouchement."
        ]
        ,
        Public:`Sages-femmes`,
        tarif: "336,60",
        ...
        {introduction:"La formation débute par une introduction au programme, la présentation du formateur, ainsi qu’une évaluation de positionnement permettant de mesurer les connaissances fondamentales des participants.",
          ...
          Presentation_module:[
            "Organisation du suivi de grossesse ",
            "Prévention et informations autour de la grossesse ",
            "Interrogatoire et examen clinique obstétrical",
            "Bilans paracliniques de la grossesse ",
            "Thérapeutiques de la grossesse",
            "Principales pathologies obstétricales",
            "Travail en réseau et dépistage des vulnérabilités ",
            "Cas clinique 1",
            "Cas clinique 2",
            "Cas clinique 3",
          ...
          objectif:[
            "Connaître le cadre général du suivi de grossesse",
            "Apprendre à prévenir les risques pendant la grossesse (alimentation, actualités vaccinales)",
            "Savoir réaliser un interrogatoire complet et ciblé ainsi qu’un examen clinique adapté au terme de la grossesse et aux antécédents de la patiente. ",
            ["Connaître les examens de dépistage" , "Savoir interpréter les bilans biologiques en cours de grossesse."],
            "Connaître et savoir prescrire les traitements médicamenteux et les prises en charges non médicamenteuses de la grossesse.",
            "Savoir dépister et adresser les principales complications de grossesse.",
            "Savoir dépister les facteurs de risques de vulnérabilités (psychologiques, addictions, violences)",
            "Tester ses connaissances sur un cas clinique traitant de l’organisation du suivi de grossesse et la prise en charge de la femme enceinte. ",
            "Tester ses connaissances sur un cas clinique traitant de l’organisation du suivi de grossesse et la prise en charge de la femme enceinte. ",
            "Tester ses connaissances sur un cas clinique traitant de l’organisation du suivi de grossesse et la prise en charge de la femme enceinte. ",
...
Financements:`DPC, FIFPL, AGEFICE, OPCO, France Travail`,
  ...
  skills: [
    "Maîtrise du suivi de grossesse physiologique : Capacité à encadrer et accompagner les femmes enceintes tout au long de leur grossesse, dans le respect des recommandations en vigueur et de la politique des 1000 jours.",
    "Dépistage des facteurs de vulnérabilité : Compétence dans l’identification des facteurs de risques psychosociaux, des situations de violence, d’addictions ou de fragilité nécessitant un accompagnement spécifique ou une orientation.",
    "Analyse et interprétation des examens cliniques et paracliniques : Aptitude à prescrire, analyser et interpréter les bilans biologiques et examens de dépistage pertinents pour assurer un suivi optimal de la grossesse.",
    "Prévention et éducation à la santé : Savoir conseiller les patientes sur les mesures de prévention pendant la grossesse : alimentation, hygiène de vie, vaccination, prévention des risques infectieux et environnementaux.",
    "Dépistage des pathologies obstétricales : Compétence à reconnaître les signes d’alerte et les complications potentielles afin d’adapter le suivi, d’orienter la patiente vers une prise en charge médicale adaptée, et d'assurer la coordination des soins.",
    "Communication et accompagnement global : Capacité à instaurer une relation de confiance avec la patiente et son entourage, à délivrer une information claire et personnalisée sur le déroulement de la grossesse, de l’accouchement et du post-partum."
  ],
        ...
        {
            id:1 ,
            DateSession:"08/07/2025",
            NumSession:"25.001"
        },

        {
            id:2 ,
            DateSession:"17/07/2025",
            NumSession:"25.002"
        },
...
import comptabilite from "../images/formations/comptabilité.jpg"
import digital from "../images/formations/Digital.webp"
import mangement from "../images/formations/mangement.jpg"
import VenteNegotiation from "../images/formations/vente&negotiation.jpg"
