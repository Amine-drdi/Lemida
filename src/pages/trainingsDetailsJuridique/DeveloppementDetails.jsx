...
import { Developpement } from '../../assets/data/developpement'; // Assurez-vous d'importer correctement vos données
import React, { useState } from 'react';
import { useParams } from 'react-router-dom';

const FormationDetails = () => {
  const { id } = useParams(); // Récupère l'ID de l'URL
  const formation = Developpement.find((f) => f.id === parseInt(id)); // Conversion de l'ID en entier
