...
import { Digital } from '../../assets/data/digital'; // Assurez-vous d'importer correctement vos données

const FormationDetails = () => {
  const { id } = useParams(); // Récupère l'ID de l'URL
  const formation = Digital.find((f) => f.id === parseInt(id)); // Conversion de l'ID en entier
