...
import { Management } from '../../assets/data/management'; // Assurez-vous d'importer correctement vos données

const FormationDetails = () => {
  const { id } = useParams(); // Récupère l'ID de l'URL
  const formation = Management.find((f) => f.id === parseInt(id)); // Conversion de l'ID en entier
