...
import {Marketing} from '../../assets/data/marketing'; // Assurez-vous d'importer correctement vos données
...
const FormationDetails = () => {
  ...
  const formation = Marketing.find((f) => f.id === parseInt(id)); // Conversion de l'ID en entier
