...
import {Paocao} from '../../assets/data/paocao'; // Assurez-vous d'importer correctement vos données



const FormationDetails = () => {
  const { id } = useParams(); // Récupère l'ID de l'URL
  const formation = Paocao.find((f) => f.id === parseInt(id)); // Conversion de l'ID en entier
