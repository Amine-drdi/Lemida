    ...
    <div className="relative w-full bg-gradient-to-r from-gray-200 to-main_color md:px-desktop_padding sm:px-tablet_padding px-mobile_padding py-16">
      <div className="w-full grid md:grid-cols-2 grid-cols-1">
        ...
        <div className="relative max-md:hidden">
         ...
         <div className="absolute 2xl:left-0  xl:left-[calc(50%-256px)] left-[5%] top-[25%]">
            <img
              src="/images/btp.jpg"
              alt="about hero"
          ...
          <div className="absolute 2xl:right-[calc(50%-250px)] xl:right-[calc(50%-300px)] right-[1%] top-[65%]">
            <img
